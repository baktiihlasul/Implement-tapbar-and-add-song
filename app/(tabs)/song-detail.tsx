...
const MOCK_SONGS = [
  {
    ...
    audioUrl: 'https://example.com/audio/the-nights.mp3',
  },
  {
    id: '2',
    title: 'Faded',
...
export default function SongDetailScreen() {
  ...
  return (
    <ThemedView style={{ flex: 1, padding: 16 }}>
      ...
      <TouchableOpacity style={styles.playButton} onPress={() => Linking.openURL(song.youtubeUrl)}>
        <Ionicons name="logo-youtube" size={24} color="#fff" />
        <ThemedText style={{ color: '#fff', marginLeft: 8 }}>Watch on YouTube</ThemedText>
      </TouchableOpacity>
      {/* Info Table Section */}
